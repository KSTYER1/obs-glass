...
Assert-Contains $source "OBS_SOURCE_VIDEO\s*\|\s*OBS_SOURCE_CUSTOM_DRAW\s*\|\s*OBS_SOURCE_COMPOSITE" "glass source output_flags must include OBS_SOURCE_COMPOSITE."
